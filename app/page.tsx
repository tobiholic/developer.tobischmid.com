    ...
    <div className=" px-5 bg-gradient-to-tl from-black to-gray-900 relative overflow-hidden">
      ...
      >
        ...
        <div className="flex gap-4 mt-8">
          ...
          >
            <button className="px-4 py-3 font-bold text-slate-300 rounded-2xl border border-1 border-purple-800 border-solid bg-purple-800 hover:scale-105 transition-all">
              Get in touch
            </button>
          </Link>
          <Link
        ...
        <div className="flex mt-10 gap-5 justify-center">
          ...
          >
            <svg
              ...
              fill="none"
              className="stroke-slate-400 hover:stroke-purple-800  hover:scale-110"
            >
              <path
                strokeWidth="12"
          ...
          >
            <svg
              ...
              className="stroke-slate-400 hover:stroke-purple-800 hover:fill-purple-800 hover:scale-110"
            >
              <g>
                <g>
                  <path
        ...
        <div className="md:absolute mt-16 md:mt-0 bottom-1 animate-bounce flex flex-col gap-3 place-items-center">
          ...
          <svg
            ...
            fill="none"
            xmlns="http://www.w3.org/2000/svg"
            className="stroke-purple-800  fill-purple-800 hover:scale-110"
          >
          ...
          <div className="relative w-[330px] hover:scale-[102%] transition-all text-slate-400 border border-1 rounded-xl border-black shadow-sm shadow-purple-800">
            ...
            <div className="p-3 bg-gradient-to-tr from-gray-900 via-gray-950 to-transparent rounded-b-lg">
              <Link
                ...
                className="z-20"
              >
                <h4 className="text-xl mb-3 underline underline-offset-4 decoration-purple-950 hover:decoration-purple-800">
                  fernschicht.de
                </h4>
              </Link>
              <p className="mb-5">
          ...
          <div className="relative w-[330px] hover:scale-[102%] transition-all text-slate-400 border border-1 rounded-xl border-black shadow-sm shadow-purple-800 ">
            ...
            <div className="p-3 bg-gradient-to-tr from-gray-900 via-gray-950 to-transparent rounded-b-lg">
              <Link
                ...
                className="z-20"
              >
                <h4 className="text-xl mb-3 underline underline-offset-4 decoration-purple-950 hover:decoration-purple-800 z-20">
                  tobischmid.com
                </h4>
              </Link>
              <p className="mb-5">
